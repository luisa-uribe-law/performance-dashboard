...
export default function Dashboard() {
  ...
  const currentTeam = useMemo(() => {
    ...
    return {
      ...
      teamAiRatio: Math.round(entries.reduce((s, e) => s + e.teamAiRatio, 0) / entries.length * 10) / 10,
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 animate-fade-in">
                <div>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                    ...
                    <KpiCard label="AI Code Ratio" subtitle="% of code generated by AI tools" value={currentTeam.teamAiRatio} suffix="%" prevValue={prevTeam?.teamAiRatio} color="var(--accent)" deltaLabel="pp" />
                  </div>
                </div>
