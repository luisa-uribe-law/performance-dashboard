                ...
                <table className="w-full text-[13px] table-fixed">
                  ...
                  <thead>
                    <tr style={{ backgroundColor: `color-mix(in srgb, ${cfg.color} 8%, var(--surface))` }}>
                      ...
                      <th className="py-2 px-3 text-right text-[10px] font-medium uppercase tracking-wider text-[var(--muted)]" title="AI code ratio — % of code generated by AI tools">
                        <div>AI %</div>
                      </th>
                    ...
                    {devs.map((d, i) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="py-2 px-3 text-right tabular-nums">
                            <span style={{ color: d.aiCodeRatio >= 40 ? "var(--accent)" : "var(--danger)" }}>{d.aiCodeRatio}%</span>
                          </td>
